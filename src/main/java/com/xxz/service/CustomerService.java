...
public class CustomerService {
    ...
    public int insertCus(Customer customer){
        ...
        try {
            ...
            preparedStatement.setString(4, customer.getcJob());
            preparedStatement.setString(5, customer.getcTele());
            preparedStatement.setString(6, customer.getcPost());
            preparedStatement.setString(7, customer.getcHobby());
            preparedStatement.setString(8, customer.getcRemark());
